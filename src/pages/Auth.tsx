          ...
          <div className="max-w-5xl mx-auto grid md:grid-cols-2 gap-0 overflow-hidden rounded-sm border border-border shadow-lg">
            ...
            >
              ...
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 border border-border bg-background py-3 rounded-sm font-body text-sm text-foreground hover:bg-secondary hover:border-accent/30 transition-all duration-300 disabled:opacity-50"
              >
